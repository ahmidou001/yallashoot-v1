...
import { Play, Search, Film, X, Trophy, Calendar, Eye, Sparkles } from "lucide-react";
...
export default function HighlightsPage() {
  ...
  const { data: highlights = [], isLoading, isError } = useQuery<HighlightItem[]>({
      ...
      {!search && featuredHighlight && (
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-950 border border-emerald-500/20 p-6 sm:p-8 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-7 relative aspect-video bg-zinc-950 rounded-2xl overflow-hidden group border border-zinc-800 shadow-xl cursor-pointer"
